...
val TennisIconFilled: ImageVector
    get() {
        if (_TennisIconFilled != null) {
            return _TennisIconFilled!!
        }
        _TennisIconFilled = ImageVector.Builder(
            name = "TennisIconFilled",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            viewportHeight = 960f
...
private var _TennisIconFilled: ImageVector? = null
