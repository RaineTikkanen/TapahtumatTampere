...
@Composable
fun SportScreen(headerViewModel: HeaderViewModel, navController: NavController, eventUiState: EventUiState){
    headerViewModel.updateHeaderText("Urheilu")
    EventList(navController, eventUiState, viewOption = ViewOptions.SPORT)
}